...
lm_GapFractionmMean10_exhaustive<-regsubsets(Gap_Fraction_mean~DEM+
                                             TRI+
                                             slope+ aspect+ 
                                           eastwest+ northsouth+
                                            tpi10m+ tpi100m+
...
####Gap Fraction sd ####
lm_GapFraction_sd10m_exhaustive<-regsubsets(Gap_Fraction_sd~DEM+
                                               TRI+
                                               slope+ aspect+ 
                                               eastwest+ northsouth+
                                               tpi10m+ tpi100m+
...
#####################################################################################
####PAR LAI mean ####
lm_PAR_LAI_mean_10m_exhaustive<-regsubsets(PAR_LAI_mean~DEM+
                                             TRI+
                                             slope+ aspect+ 
                                             eastwest+ northsouth+
                                             tpi10m+ tpi100m+
...
####PAR LAI sd ####
lm_PAR_LAI_sd_10m_exhaustive<-regsubsets(PAR_LAI_sd~DEM+
                                             TRI+
                                             slope+ aspect+ 
                                             eastwest+ northsouth+
                                             tpi10m+ tpi100m+
...
#####################################################################################
####PAR Average mean ####
lm_PAR_Average_mean_exhaustive<-regsubsets(PAR_Average_mean~DEM+
                                           TRI+
                                           slope+ aspect+ 
                                           eastwest+ northsouth+
                                           tpi10m+ tpi100m+
...
####PAR Average SD ####
lm_PAR_Average_sd10m_exhaustive<-regsubsets(PAR_Average_sd~ DEM+
                        TRI+
                        slope+ aspect+ 
                        eastwest+ northsouth+
                        tpi10m+ tpi100m+
...
#####################################################################################
####Canopy Density Mean  ####
lm_Canopy_Density_mean_10m_exhaustive <-regsubsets(Canopy_Density_mean~ DEM+
                                       TRI+
                                       slope+ aspect+ 
                                       eastwest+ northsouth+
                                       tpi10m+ tpi100m+
...
####Canopy Density SD####
lm_Canopy_Density_sd_10m_exhaustive <-regsubsets(Canopy_Density_sd~ DEM+
                                                     TRI+
                                                     slope+ aspect+ 
                                                     eastwest+ northsouth+
                                                     tpi10m+ tpi100m+
...
#####################################################################################
#### Leaf Angle mean####
lm_Leaf_Angle_mean_10_exhaustive <-regsubsets(Leaf_Angle_mean~ DEM+
                                                   TRI+
                                                   slope+ aspect+ 
                                                   eastwest+ northsouth+
                                                   tpi10m+ tpi100m+
...
####Leaf Angle sd ####
lm_Leaf_Angle_sd_10_exhaustive <-regsubsets(Leaf_Angle_sd~ DEM+
                                                TRI+
                                                slope+ aspect+ 
                                                eastwest+ northsouth+
                                                tpi10m+ tpi100m+
...
lm_Diversity_exhaustive <-regsubsets(div~ DEM+
                                              TRI+
                                              slope+ #aspect+ 
                                              eastwest+ northsouth+
                                              tpi10m+ tpi100m+
...
#####################################################################################
####Average DBH ####
lm_DBH_mean_10m_exhaustive <-regsubsets(Average_DBH~ DEM+
                                       TRI+
                                       slope+ #aspect+ 
                                       eastwest+ northsouth+
                                       tpi10m+ tpi100m+
...
#####################################################################################
####Dbh SD ####
lm_DBH_sd_10m_exhaustive <-regsubsets(DBH_Sd~ DEM+
                                          TRI+
                                          slope+ #aspect+ 
                                          eastwest+ northsouth+
                                          tpi10m+ tpi100m+
...
#####################################################################################
####Stand Density ####
lm_Stand_Density_10m_exhaustive <-regsubsets(Stand_Density~ DEM+
                                        TRI+
                                        slope+ #aspect+ 
                                        eastwest+ northsouth+
                                        tpi10m+ tpi100m+
...
###################################################################################
####Mean Tree Height  ####
lm_TreeHeightMean_exhaustive<-regsubsets(Mean_Tree_Height~DEM+TRI+slope+aspect+ eastwest+northsouth+
                                               tpi10m+  tpi100m+  tpi1000m+
                                               lulc_reduced,
...
lm_TreeHeight_SD_exhaustive<-regsubsets(Sd_Tree_Height~DEM+TRI+slope+aspect+ eastwest+northsouth+
                                           tpi10m+  tpi100m+  tpi1000m+
                                           lulc_reduced,
                                         data=bighornDataTreeHeightsAndAge,
                                         intercept=TRUE,
...
##################################################################################
#Max Tree Height
lm_Max_TreeHeight_exhaustive<-regsubsets(Max_Tree_Height~DEM+TRI+slope+aspect+ eastwest+northsouth+
                                          tpi10m+  tpi100m+  tpi1000m+
                                          lulc_reduced,
                                        data=bighornDataTreeHeightsAndAge,
                                        intercept=TRUE,
...
lm_Average_Stand_Age10m_exhaustive<-regsubsets(Average_Stand_Age~DEM+TRI+slope+aspect+ eastwest+northsouth+
                                           tpi10m+  tpi100m+  tpi1000m+
                                           lulc_reduced,
                                         data=bighornDataTreeHeightsAndAge,
                                         intercept=TRUE,
...
![Regression Results Table](Maps/regression results.png)
